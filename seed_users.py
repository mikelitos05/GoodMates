...
LANDLORDS = [
    {
        ...
        'universidad': None,
        'carrera': None,
        'biografia': 'Administrador de propiedades en zona Tec y Obispado.',
    },
    {
...
PROPERTIES = [
    {
        ...
        'lugares_cercanos': ['ITESM Campus Monterrey', 'Soriana Garza Sada', 'Parque Tecnologico'],
        'latitud': 25.6519,
        'longitud': -100.2896,
        'destacada': True,
    },
    {
        ...
        'titulo': 'Departamento compartido en Centro Monterrey',
        'descripcion': 'Departamento con excelente ubicacion y acceso a transporte publico.',
        'direccion': 'Calle Washington 1120',
        'ciudad': 'Monterrey',
        'estado': 'Nuevo Leon',
        'precio': 7800,
        'habitaciones': 2,
        ...
        'lugares_cercanos': ['Macroplaza', 'Estacion del Metro', 'Clinica 33 IMSS'],
        'latitud': 25.6769,
        'longitud': -100.3170,
        'destacada': False,
    },
    {
        ...
        'lugares_cercanos': ['UDEM', 'Plaza Nativa', 'Hospital Zambrano'],
        'latitud': 25.6502,
        'longitud': -100.3595,
        'destacada': True,
    },
    {
        ...
        'lugares_cercanos': ['Galerias Monterrey', 'Facultad de Medicina UANL'],
        'latitud': 25.6866,
        'longitud': -100.3448,
        'destacada': False,
    },
...
GROUP_ASSIGNMENTS = [
    {
        ...
        'group_name': 'Roomies Distrito Tec',
        'creator': 'carlos_mtz',
        'members': ['carlos_mtz', 'ana_lopez', 'mariana_castillo'],
    },
    {
        'property_key': 'depa_centro_mty',
        'group_name': 'Centro Mty Team',
        'creator': 'diego_hdz',
...
EXTRA_INQUIRIES = [
    {'tenant': 'roberto_silva', 'property_key': 'suite_obispado', 'estado': 'pendiente', 'mensaje': 'Me interesa visitar el lugar esta semana.'},
    {'tenant': 'sofia_ramirez', 'property_key': 'loft_tecdistrito', 'estado': 'rechazada', 'mensaje': 'Busco estancia de 12 meses.'},
    {'tenant': 'miguel_torres', 'property_key': 'casa_udem', 'estado': 'aceptada', 'mensaje': 'Me interesa por cercania al trabajo.'},
    {'tenant': 'ana_lopez', 'property_key': 'casa_udem', 'estado': 'egresada', 'mensaje': 'Fue una buena experiencia, deseo volver a aplicar.'},
]
...
RATINGS = [
    ...
    {'from': 'mariana_castillo', 'to': 'carlos_mtz', 'property_key': 'loft_tecdistrito', 'score': 4.8, 'comment': 'Excelente companero de casa.'},
    {'from': 'carlos_mtz', 'to': 'mariana_castillo', 'property_key': 'loft_tecdistrito', 'score': 4.5, 'comment': 'Convivencia muy buena.'},
...
MATCHES = [
    {'u1': 'sofia_ramirez', 'u2': 'miguel_torres', 'compat': 88, 'estado': 'pendiente'},
    {'u1': 'roberto_silva', 'u2': 'mariana_castillo', 'compat': 76, 'estado': 'aceptado'},
    {'u1': 'valentina_gzz', 'u2': 'sofia_ramirez', 'compat': 61, 'estado': 'rechazado'},
    {'u1': 'diego_hdz', 'u2': 'roberto_silva', 'compat': 70, 'estado': 'aceptado'},
]

MATCH_CHAT_MESSAGES = {
    ('roberto_silva', 'mariana_castillo'): [
        ('roberto_silva', 'Hola Mariana, vi que tenemos match y compatibilidad alta.'),
        ('mariana_castillo', 'Hola! Si, me interesa platicar sobre reglas de convivencia.'),
        ('roberto_silva', 'Perfecto, para mi es clave mantener silencio entre semana.'),
    ],
    ('diego_hdz', 'roberto_silva'): [
        ('diego_hdz', 'Que tal Roberto, gusto en saludarte.'),
        ('roberto_silva', 'Igualmente Diego, podemos revisar opciones de renta juntos.'),
    ],
}
